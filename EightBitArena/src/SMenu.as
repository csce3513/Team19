package  
{
	...
	public class SMenu extends Sprite
	{
		
		private var __MenuArray:Array = new Array("Start Game", "Options");	
		private var buttonNames:Array = new Array("Start Game", "Options");
		...
		public function SMenu(stage:Stage,gamestate:Number,eb:EightBitArena)
		{
